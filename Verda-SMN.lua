...
--so that's why heliosmab is first
    ...
    sets.precast.BloodPactWard = { --I just stack it all because when I do salvage or a gear slot is locked by a NM it's nice
	    ...
	    ear2="Evans Earring",
	    waist="Lucidity sash",
	    back={ name="Conveyance Cape", augments={'Summoning magic skill +2','Blood Pact Dmg.+1','Blood Pact ab. del. II -3',}}, --II -3
	    --gift -5
    }
...
--    }
    ...
    sets.midcast.Pet.PhysicalBloodPactRage = {
	    ...
	    left_ring="Evoker's ring",
	    right_ring="Fervor Ring",
	    back={ name="Conveyance Cape", augments={'Summoning magic skill +2','Blood Pact Dmg.+5','Pet: Enmity +11',}},
	    feet="Apogee Pumps",
    }
